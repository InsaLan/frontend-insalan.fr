...
<template>
  <div
    v-if="visible"
    :class="toastType"
    class="w-min-[500px] fixed bottom-1 left-1/2 z-40 mb-4 ml-[-250px] flex w-full max-w-xs items-center rounded-lg p-4 text-white shadow hover:ring-2"
  >
    ...
    >
      ...
      <svg
        class="h-5 w-5 stroke-2 text-white"
        fill="none"
        stroke="currentColor"
        stroke-width="1.5"
        viewBox="0 0 24 24"
