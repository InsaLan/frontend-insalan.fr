  ...
  <section class="grid-row-2 grid grid-cols-2 border-t-2 border-white md:grid-cols-12 md:grid-rows-1">
    <div class="row-start-2 flex flex-col items-center justify-items-center md:col-span-3 md:row-start-1">
      ...
      <div class="flex w-min flex-row">
        <a class="hover:blur-sm" href="https://www.instagram.com/insalan_officiel">
          <svg
            id="instagram"
            ...
            <g>
              ...
              <g transform="matrix(2.0 0 0 2.0 100 100)">
                ...
                <path
                  ...
                  stroke-linecap="round"
                  style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: miter; stroke-miterlimit: 4; is-custom-font: none; font-file-url: none; fill: url(#SVGID_462); fill-rule: nonzero; opacity: 1;"
              ...
              <g transform="matrix(2.0 0 0 2.0 100 100)">
                ...
                <path
                  ...
                  stroke-linecap="round"
                  style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: miter; stroke-miterlimit: 4; is-custom-font: none; font-file-url: none; fill: url(#SVGID_472); fill-rule: nonzero; opacity: 1;"
                  transform=" translate(-105.59, -225.93)"
                />
              </g>
        ...
        <a class="hover:blur-sm" href="https://twitter.com/insalan">
          <svg
            id="X"
            class="h-10 w-10 md:h-14 md:w-14"
            viewBox="0 0 200 200"
        ...
        <a class="hover:blur-sm" href="https://www.facebook.com/insalan/">
          <svg
            id="facebook"
            class="h-10 w-10 md:h-14 md:w-14"
            viewBox="0 0 200 200"
    ...
    <div class="col-span-3 flex flex-row">
      <div class="mx-2 flex flex-row justify-end">
        <a class="mt-2 md:mt-5 " href="https://aeir.insa-rennes.fr">
          <img
            alt="Logo de l'AEIR"
