  ...
  <div class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
      <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
        <div class="relative overflow-hidden rounded-lg bg-theme-bg text-left shadow-xl transition-all sm:my-8 sm:max-w-lg">
          ...
          <div class="items-center justify-center px-4 pb-4 sm:flex sm:flex-row-reverse sm:px-6">
            <slot name="buttons">
              ...
              <button type="button" class="mt-3 inline-flex w-full justify-center rounded-md bg-gray-500 px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-300 sm:mt-0 sm:w-auto">
                Cancel
              </button>
            </slot>
          </div>
