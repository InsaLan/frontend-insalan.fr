<!-- This is a Vue file because otherwise the fill color doesn't get inherited properly -->

<template>
  <svg id="X" fill="currentColor" viewBox="30 30 140 140" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
    <title>
      Twitter / X
    </title>
    <g>
