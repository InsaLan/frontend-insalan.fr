	...
	<div class="flex ml-1">
		<div id="profile" class="w-1/4 items-center">
			...
			<div class="m-4 rounded-2xl">
				<div class="m-2">
					<p class="text-xl">Pseudo : <em>{{user.username}}</em>  <fa-awesome-icon size="2xs" icon="fa-solid fa-pencil" /></p>
					<p class="text-xl">Email : <em>{{user.email}}</em>  <fa-awesome-icon size="2xs" icon="fa-solid fa-pencil" /></p>
					<p class="text-xl">Mot de passe : <em>***********</em>  <fa-awesome-icon size="2xs" icon="fa-solid fa-pencil" /></p>
				</div>
