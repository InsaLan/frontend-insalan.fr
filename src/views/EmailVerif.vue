...
<template>
    ...
    <div v-else>
        <div>
            ...
            <p class=" text-center md:text-2xl md:m-8"> L'adresse a déjà été vérifiée ou le lien est invalide</p>
            <p class=" text-center md:text-2xl md:m-8 m-4"> Revenir à :</p>
            <p class="text-center text-2xl md:m-6 m-6" ><router-link class="hover:text-cyan-300 border-white border-4 p-4" to="/register">Créer un compte</router-link></p>
        </div>
