        ...
        <Suspense timeout="0">
          ...
          <template #fallback>
            <div class="flex w-full flex-1 flex-col items-center justify-center gap-5">
              ...
              <div role="status">
                <svg aria-hidden="true" class="h-16 w-16 animate-spin fill-blue-600 text-gray-200 dark:text-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
